...
export default function WishList({info}){
    ...
    return(
        <>
        <div className="flex flex-row border rounded-xl mt-[25px] small:flex-col small:items-center small:py-6 medium:flex medium:flex-col medium:items-center medium:py-6">
